...
//  Create a helper method to give you the list of files inside of all_files folder
...
//    Use getAllFiles() method to give you the list of files inside of all_files folder and sort them
    ...
    @Override
    public void addFileToDirectory() throws Exception {
...
//    Return a message if FNF (File not found)
    @Override
    public void deleteFileInDirectory() throws Exception {
